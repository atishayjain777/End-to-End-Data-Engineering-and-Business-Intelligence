...
![SQL](https://img.shields.io/badge/Advanced-SQL-success?style=for-the-badge)
...
│
├── 04_Fact_Tables
│   ├── fact_actual_estimate.sql
│   ├── fact_forecast_monthly.sql
│
├── 05_Data_Cleaning_Transformation
│   ├── null_handling.sql
│   ├── update_queries.sql
│   ├── case_when.sql
│   ├── coalesce_ifnull.sql
...
│
├── 14_Events
│   ├── scheduled_events.sql
│
├── 15_Forecast_Accuracy
│   ├── forecast_accuracy.sql
│   ├── net_error.sql
│   ├── abs_error.sql
│   ├── forecast_bias.sql
│
├── 16_Supply_Chain_Analytics
│   ├── supply_chain_queries.sql
│
├── 17_Business_Analysis
